#include "SettingsWidgetActor.h"


ASettingsWidgetActor::ASettingsWidgetActor() : Super() {
    
}


//init on beginplay
void ASettingsWidgetActor::CreateWidgetMeshData(){
    if(!bMeshDataCreated && Widget){
        float xMax = 600.0f; // 1920.0f;
...
void ASettingsWidgetActor::ScaleMeshDataToDesiredScale(){
