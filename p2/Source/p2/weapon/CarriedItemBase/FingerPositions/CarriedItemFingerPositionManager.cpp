...
void CarriedItemFingerPositionManager::UpdateFrom(AActorBase *baseActor){
    OverrideComponent(EArmType::ELeft, HandBoneIndexEnum::thumb, baseActor);
    OverrideComponent(EArmType::ELeft, HandBoneIndexEnum::finger1, baseActor);
    OverrideComponent(EArmType::ELeft, HandBoneIndexEnum::finger2, baseActor);
    OverrideComponent(EArmType::ELeft, HandBoneIndexEnum::finger3, baseActor);
    OverrideComponent(EArmType::ELeft, HandBoneIndexEnum::finger4, baseActor);

    OverrideComponent(EArmType::ERight, HandBoneIndexEnum::thumb, baseActor);
    OverrideComponent(EArmType::ERight, HandBoneIndexEnum::finger1, baseActor);
    OverrideComponent(EArmType::ERight, HandBoneIndexEnum::finger2, baseActor);
    OverrideComponent(EArmType::ERight, HandBoneIndexEnum::finger3, baseActor);
    OverrideComponent(EArmType::ERight, HandBoneIndexEnum::finger4, baseActor);

    
    OverrideComponent(EArmType::ELeft, baseActor);
    OverrideComponent(EArmType::ERight, baseActor);
...
void CarriedItemFingerPositionManager::UpdateContainer(
    ...
    UpdateContainer(data, actor, EArmType::ELeft);
    UpdateContainer(data, actor, EArmType::ERight);
}
...
void CarriedItemFingerPositionManager::OverrideComponent(
    EArmType typeArm, 
    HandBoneIndexEnum index,
    ...
    if(baseActor){
        ...
        if(scene){
            OverrideComponent(typeArm, index, scene);
        }
    }
}
...
void CarriedItemFingerPositionManager::OverrideComponent(
    ...
    if(baseActor){
        ...
        if(scene){
            OverrideComponent(typeArm, scene);
        }
    }
}
