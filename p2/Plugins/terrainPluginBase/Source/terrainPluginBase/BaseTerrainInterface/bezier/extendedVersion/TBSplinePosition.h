...
template <typename T>
class TERRAINPLUGINBASE_API TBSplinePosition
{
public:
	TBSplinePosition(){}
...
class TERRAINPLUGINBASE_API FVector2DBSplinePosition : public TBSplinePosition<FVector2D> {
...
class TERRAINPLUGINBASE_API FVectorBSplinePosition : public TBSplinePosition<FVector> {
