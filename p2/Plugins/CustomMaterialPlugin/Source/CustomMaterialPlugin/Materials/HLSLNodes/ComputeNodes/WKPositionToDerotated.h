...
#include "WKPositionToDerotated.generated.h"

/// @brief deriving from material expression node for materials.
/// creates the position on the xy pane based on normal.
UCLASS(collapsecategories, hidecategories=Object)
class CUSTOMMATERIALPLUGIN_API UWKPositionToDerotated : public UWKVertexShaderBase
{
    GENERATED_BODY()
public:
    ...
    virtual FString NodeName() const override{
        return TEXT("UWKPositionToDerotated");
    }
