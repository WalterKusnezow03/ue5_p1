...
class ANYMESHWIDGETPLUGIN_API UAnyMeshWidgetComponentBase : public UWidgetComponent
//UWidgetComponentCustom
{
	GENERATED_BODY()
public:
    UAnyMeshWidgetComponentBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
    {
    ...
    virtual bool RayIntersectHover(
        const FVector &origin,
        const FVector &direction
    );
