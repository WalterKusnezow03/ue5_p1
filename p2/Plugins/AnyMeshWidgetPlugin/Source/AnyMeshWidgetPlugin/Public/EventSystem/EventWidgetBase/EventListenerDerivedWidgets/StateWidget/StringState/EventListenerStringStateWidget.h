...
#include "AnyMeshWidgetPlugin/Public/EventSystem/EventWidgetBase/EventListenerDerivedWidgets/StateWidget/IndexState/EventListenerIndexStateWidget.h"
...
class ANYMESHWIDGETPLUGIN_API UEventListenerStringStateWidget : public UEventListenerIndexStateWidget {
    GENERATED_BODY()
