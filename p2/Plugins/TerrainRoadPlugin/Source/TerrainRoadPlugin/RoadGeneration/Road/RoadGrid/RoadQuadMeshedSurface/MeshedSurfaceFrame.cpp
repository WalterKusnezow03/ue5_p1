...
void FMeshedSurfaceFrame::UpdateHeightOnVertecies(TerrainInterfaceBase *creator){
...
void FMeshedSurfaceFrame::UpdateHeight(TerrainInterfaceBase *creator, FVector &vertex, float offset){
    if(creator){
